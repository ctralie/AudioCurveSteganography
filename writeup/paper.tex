...
%
\author{Christopher J Tralie\inst{1}\orcidID{0000-0003-4206-1963}}
%
...
\begin{figure}
  \centering
  \includegraphics[width=0.8\columnwidth]{HamiltonianHorse.pdf}
...
\begin{figure}
  \centering
  \includegraphics[width=0.9\columnwidth]{WindowEffect.pdf}
...
\begin{figure}
  \centering
  \includegraphics[width=0.9\columnwidth]{LambdaEffect.pdf}
...
\begin{figure}
  ...
  %\includegraphics[width=0.9\columnwidth]{MeshSegGTzanFixedLam.pdf}
...
% We see a Pearson correlation of $r=0.48$ between the mean opinion score and the SNR in dB.  
...
\begin{figure}
  ...
  \begin{minipage}[c]{0.64\textwidth}
    \includegraphics[width=\columnwidth]{Turk.pdf}
  \end{minipage}\hfill
